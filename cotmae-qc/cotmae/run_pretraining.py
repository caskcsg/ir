...
from data import CotMAEDatasetForSpanSampling, CotMAECollator
...
def main():
    ...
    if data_args.sample_from_spans:
        train_dataset = CotMAEDatasetForSpanSampling(train_dataset, data_args)
    eval_dataset = None
    ...
    data_collator = CotMAECollator(
        tokenizer=tokenizer,
        bert_mask_ratio=data_args.bert_mask_ratio,
