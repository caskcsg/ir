...
python $SCRIPT_DIR/build_train.py --tokenizer_name $TOKENIZER --negative_file train.negatives.tsv --qrels qrels.train.tsv --n_sample 128 \
...
python $SCRIPT_DIR/tokenize_passages.py --tokenizer_name $TOKENIZER --n_splits 8 --file corpus.tsv --save_to $TOKENIZER_ID/corpus
